...
public class Utils {
  ...
  public static IloIntExpr getArraySum(IloCplex cplex, IloIntVar[] intVarArray)
      throws IloException {
  ...
  public static IloNumExpr getArraySum(IloCplex cplex, IloNumVar[] numVarArray)
      throws IloException {
  ...
  public static IloNumExpr getRowSum(IloCplex cplex, IloNumVar[][] numVarMatrix, int row)
      throws IloException {
    IloNumExpr sum = cplex.linearNumExpr();
  ...
  public static IloIntExpr getRowSum(IloCplex cplex, IloIntVar[][] numVarMatrix, int row)
      throws IloException {
    IloIntExpr sum = cplex.linearIntExpr();
  ...
  public static IloNumExpr getColumnSum(IloCplex cplex, IloNumVar[][] numVarMatrix, int column)
      throws IloException {
    IloNumExpr sum = cplex.linearNumExpr();
  ...
  public static IloIntExpr getColumnSum(IloCplex cplex, IloIntVar[][] numVarMatrix, int column)
      throws IloException {
    IloIntExpr sum = cplex.linearIntExpr();
  ...
  public static boolean getBoolValue(IloCplex cplex, IloNumVar iloNumVar, int solutionIndex)
      throws IloException {
  ...
  public static Set<Integer> bitSetToIntSet(BitSet arr) {
    return arr.stream().boxed().collect(Collectors.toSet());
  }
