...
INSTANCES = [
    ...
    random_instance_many_neighbors(50),
    random_instance_many_neighbors(60),
    random_instance_many_neighbors(70),
    random_instance_many_neighbors(80),
    random_instance_many_neighbors(90),
    random_instance_many_neighbors(100),
]
